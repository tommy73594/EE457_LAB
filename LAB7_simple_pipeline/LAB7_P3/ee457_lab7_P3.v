...
assign FORW1 =  (EX1_XMEX2 & WB_WRITE) | PRIORITY; // Decide whether to receive any forwarding help or carry EX1_XD
...
assign FORW2 = EX2_XMEX1 & WB_WRITE & (EX2_ADD4 | EX2_MOV);  // Is it a case of forwarding date from the WB stage
