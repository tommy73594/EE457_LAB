...
// test #2 begin
	TEST_ALU (14, 5, 0, 0, 2); // (A,B,AINV,BNEG,Opr)  ADD
// test #2 end

// test #3 begin
	TEST_ALU (5, 4, 0, 0, 2); // (A,B,AINV,BNEG,Opr)  ADD
// test #3 end
...
// test #5 begin
	TEST_ALU (5, 3, 0, 1, 2); // (A,B,AINV,BNEG,Opr)  SUB
// test #5 end

// test #6 begin
	TEST_ALU (5, 6, 0, 1, 2); // (A,B,AINV,BNEG,Opr)  SUB
// test #6 end

// test #7 begin
	TEST_ALU (11, 4, 0, 1, 2); // (A,B,AINV,BNEG,Opr)  SUB
// test #7 end

// test #8 begin
	TEST_ALU (6, 12, 0, 1, 2); // (A,B,AINV,BNEG,Opr)  SUB
// test #8 end
